...
> The `enhancedEffects` hydration mapper was removed on 2026-09-11. Current settings use only `visualEffects`; this does not add or remove locale keys. See [[docs/adr/135-compatibility-cutoff-for-september-retirements|ADR-135]].
