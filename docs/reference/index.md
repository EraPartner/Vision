...
| [[docs/reference/analysis-contract\|Analysis Contract]]                    | Versioned definitions, parameters, results, lineage, windows, and compatibility                             |
| [[docs/reference/analysis-datasets\|Analysis Datasets]]                    | Approved financial views, grain, semantics, and reconciliation                                              |
| [[docs/reference/code-patterns\|Code Patterns]]                            | Standard patterns for all layers (routes, services, repositories, components)                               |
| [[docs/reference/service-layer\|Service Layer Reference]]                  | Backend service architecture, domain seams, and major public services                                       |
...
| [[docs/reference/frontend-routes\|Frontend Routes]]                        | Complete manifest-backed route table, including the manual analysis workspace                               |
...
| [[docs/reference/api-client-methods\|API Client Methods Reference]]        | Archived monolithic client reference; use the frontend API client architecture                              |
