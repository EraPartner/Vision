...
| GET | `/api/cross-workspace/unified-tax` | Unified tax view: owner-allocated earned income + dividends + realized gains for `?year=` (indicative; ADR-098) | — | — |
