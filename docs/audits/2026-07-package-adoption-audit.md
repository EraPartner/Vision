...
timers/promises) and **PKG-05** (only the finite-filtered chart y-domains were
swapped; the x-domain spreads and Sparkline moved to the do-not list).
