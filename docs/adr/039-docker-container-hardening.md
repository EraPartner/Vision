...
> [!warning] Superseded
> [[docs/adr/133-native-only-runtime-and-delivery|ADR-133]] retired the active Docker runtime,
> image, and delivery path on 2026-09-08. This record remains as historical context.
