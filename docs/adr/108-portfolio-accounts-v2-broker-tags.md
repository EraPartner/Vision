...
status: accepted
date: 2026-07-10
tags: [adr, accounts, portfolio, broker-tags, cost-basis, per-account, adr-090, adr-091, adr-095, adr-100, adr-103]
...
(recorded verbatim in `TODO.md` § *Accounts research* → *5️⃣*):
...
**Math: partitions of the one global engine.** Per-broker positions *and* P&L
