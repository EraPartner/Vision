---
title: ADR-107 Flat investments schema is canonical — one-time legacy-install conversion
type: adr
status: accepted
date: 2026-07-10
...
aliases: [flat investments schema, inheritance conversion, adr-107]
---

# ADR-107: Flat investments schema is canonical — one-time legacy-install conversion
...
- ADR-004 remains as history; its Status should be updated to "Superseded by ADR-107".
