...
> [!abstract] Overview
> Three system observability dashboard pages gated behind the Admin Mode toggle in Settings (ADR-034). All pages consume typed API methods from `apiClient.admin.*` with error handling and loading states.
