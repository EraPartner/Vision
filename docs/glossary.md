...
| **Inheritance Tables**   | Retired pre-0087 investment-storage pattern; current installs use the ADR-109 flat schema      | [[docs/adr/109-flat-investments-schema-canonical\|ADR-109]] |
