...
function writeInstallerScript({
  ...
  const script = [
    ...
    "rsync_ok=0",
    'rsync -a --delete --exclude ".env" --exclude "postgres_data" --exclude ".git" --exclude "node_modules" --exclude "packaging/electron/native-runtime" "$SRC_ROOT/" "$DEST_ROOT/" && rsync_ok=1',
