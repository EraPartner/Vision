...
describe('executePlanned — recurrence bounds (migration 0071)', () => {
  it('an unbounded recurrence advances to the next date', async () => {
    ...
    await executePlanned({ id: 1, executedTransactionId: 9, executionDate: '2026-07-01' });

    expect(advancedFields()).toMatchObject({ planned_date: '2026-08-01', is_executed: false });
  });
