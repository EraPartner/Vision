...
describe("calculateCostBasisByMethod", () => {
  ...
  it('routes "weighted_avg" to calculateCostBasis', () => {
    expect(calculateCostBasisByMethod(txns, "weighted_avg").realizedGain).toBe(
      25,
    ); // sell 5 @ avg 15 → cost 75; gain 25
  });
...
describe("computeHeatmap", () => {
  it("returns empty shape for fewer than 2 snapshots", () => {
    ...
    expect(
      computeHeatmap([
        { snapshot_date: "2025-04-01", value: 100, invested: 100 },
      ]),
