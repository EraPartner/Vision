...
describe('VisionAdapter', () => {
  ...
  it('parses valid rows and skips invalid date or amount rows', () => {
...
`;
  ...
  it('uses UNKNOWN recipient when recipient is empty', () => {
    const csv = `Date,Bank Account,Recipient,Memo,Amount,Currency,Balance,Category,Comment
...
`;
  ...
  it('defaults bank account to VISION and currency to EUR', () => {
    const csv = `Date,Bank Account,Recipient,Memo,Amount,Currency,Balance,Category,Comment
...
`;
  ...
  it('builds comment from imported category and existing comment', () => {
    const csv = `Date,Bank Account,Recipient,Memo,Amount,Currency,Balance,Category,Comment
...
`;
  ...
  it('normalizes memo to uppercase', () => {
    const csv = `Date,Bank Account,Recipient,Memo,Amount,Currency,Balance,Category,Comment
