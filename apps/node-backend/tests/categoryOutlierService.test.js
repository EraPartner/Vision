...
describe("detectCategoryOutliers", () => {
  ...
  it("compares like-for-like windows — never a full prior month vs the partial current month", async () => {
    ...
    mockQuery.mockResolvedValueOnce({
      rows: [
        row("2026-01-05", "-75.00"),
        row("2026-01-15", "-80.00"),
        row("2026-01-25", "-150.00"),
        row("2026-02-05", "-78.00"),
        row("2026-02-15", "-80.00"),
        row("2026-02-25", "-150.00"),
        row("2026-03-05", "-74.00"),
        row("2026-03-15", "-79.00"),
        row("2026-03-25", "-150.00"),
        row("2026-04-05", "-76.00"),
        row("2026-04-15", "-82.00"),
        row("2026-04-25", "-150.00"),
        row("2026-05-05", "-73.00"),
        row("2026-05-15", "-78.00"),
        row("2026-05-25", "-150.00"),
        row("2026-06-05", "-77.00"),
        row("2026-06-15", "-81.00"),
        row("2026-06-25", "-150.00"),
        // Current month through day 15 (day-15 row checks boundary inclusion)
        row("2026-07-04", "-80.00"),
        row("2026-07-15", "-78.00"),
      ],
    });
      ...
      [
        {
          categoryId: 1,
          monthKey: "2026-07",
          dismissedAt: new Date(2026, 6, 10).toISOString(),
          deviationAtDismiss: 1,
        },
        {
          categoryId: 1,
          monthKey: "2026-07",
          dismissedAt: new Date(2026, 6, 14).toISOString(),
          deviationAtDismiss: 5,
        },
      ],
      now,
    );
