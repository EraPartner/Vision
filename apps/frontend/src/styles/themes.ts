...
export type ThemeVariant =
    "default" | "dracula" | "solarized" | "nord" | "high-contrast";
...
const defaultLight: ThemeTokens = {
    background: REPORT_THEME_DEFAULTS.light.surface,
    foreground: REPORT_THEME_DEFAULTS.light.text,
    card: "0 0% 100%",
    "card-foreground": "200 18% 10%",
    popover: "0 0% 100%",
    "popover-foreground": "200 18% 10%",
    muted: "40 22% 92%",
    "muted-foreground": REPORT_THEME_DEFAULTS.light.muted,
    secondary: "42 18% 93%",
    "secondary-foreground": "200 18% 10%",
    border: REPORT_THEME_DEFAULTS.light.border,
    input: "40 18% 85%",
    primary: REPORT_THEME_DEFAULTS.light.primary,
    "primary-foreground": "42 30% 97%",
    accent: REPORT_THEME_DEFAULTS.light.accent,
    ...
    "chart-3": REPORT_THEME_DEFAULTS.light.chart3,
    "chart-4": REPORT_THEME_DEFAULTS.light.chart4,
    "chart-5": REPORT_THEME_DEFAULTS.light.chart5,
    "chart-6": REPORT_THEME_DEFAULTS.light.chart6,
    "chart-7": REPORT_THEME_DEFAULTS.light.chart7,
    "chart-8": REPORT_THEME_DEFAULTS.light.chart8,
    "sidebar-background": "42 24% 96%",
    "sidebar-foreground": "200 14% 22%",
    "sidebar-primary": "164 78% 26%",
    "sidebar-primary-foreground": "42 30% 97%",
    "sidebar-accent": "42 18% 90%",
    "sidebar-accent-foreground": "200 18% 10%",
    "sidebar-border": "42 15% 85%",
    "sidebar-ring": "164 78% 26%",
...
const defaultDark: ThemeTokens = {
    background: REPORT_THEME_DEFAULTS.dark.surface,
    foreground: REPORT_THEME_DEFAULTS.dark.text,
    card: "200 18% 11%",
    "card-foreground": "42 25% 96%",
    popover: "200 20% 9%",
    "popover-foreground": "42 25% 96%",
    muted: "200 14% 14%",
    "muted-foreground": REPORT_THEME_DEFAULTS.dark.muted,
    secondary: "200 14% 14%",
    "secondary-foreground": "42 25% 96%",
    border: REPORT_THEME_DEFAULTS.dark.border,
    input: "200 14% 18%",
    primary: REPORT_THEME_DEFAULTS.dark.primary,
    "primary-foreground": "200 20% 6%",
    accent: REPORT_THEME_DEFAULTS.dark.accent,
    ...
    "chart-3": REPORT_THEME_DEFAULTS.dark.chart3,
    "chart-4": REPORT_THEME_DEFAULTS.dark.chart4,
    "chart-5": REPORT_THEME_DEFAULTS.dark.chart5,
    "chart-6": REPORT_THEME_DEFAULTS.dark.chart6,
    "chart-7": REPORT_THEME_DEFAULTS.dark.chart7,
    "chart-8": REPORT_THEME_DEFAULTS.dark.chart8,
    "sidebar-background": "200 22% 6%",
    "sidebar-foreground": "42 18% 82%",
    "sidebar-primary": "160 74% 52%",
    "sidebar-primary-foreground": "200 20% 6%",
    "sidebar-accent": "200 18% 12%",
    "sidebar-accent-foreground": "42 25% 96%",
    "sidebar-border": "200 14% 16%",
    "sidebar-ring": "160 74% 52%",
