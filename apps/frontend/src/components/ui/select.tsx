...
>(({className, ...props}, ref) => (
    <SelectPrimitive.Label
        ref={ref}
        className={cn("py-1.5 pl-8 pr-2 text-[11px] font-medium uppercase tracking-[0.12em] text-muted-foreground/80", className)}
        {...props}
    />
));
