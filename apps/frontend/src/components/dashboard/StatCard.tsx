...
export function StatCard({ title, value, numericValue, change, changeType = "neutral", subtitle, icon: Icon, trend = "neutral", formatValue }: StatCardProps) {
    ...
    return (
        <Card
            className={`group relative overflow-hidden border-none shadow-lg card-elevated hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 bg-gradient-to-br ${trendGradient} backdrop-blur-sm`}>
            <div
