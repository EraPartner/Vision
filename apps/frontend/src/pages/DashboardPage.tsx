    ...
    return (
        <div className="space-y-8 animate-in">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <StatCard title="Total Spending" value={`€${totalSpending.toFixed(2)}`} icon={TrendingDown} trend="down"
                          subtitle="-12% from last month"/>
                <StatCard title="Total Income" value={`€${totalIncome.toFixed(2)}`} icon={ArrowUpRight} trend="up"
                          subtitle="+3% from last month"/>
                <StatCard title="Net Balance" value={`€${netBalance.toFixed(2)}`} icon={DollarSign}
