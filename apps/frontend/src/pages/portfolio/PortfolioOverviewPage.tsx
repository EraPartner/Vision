...
function getPortfolioWidgets(t: (key: string) => string): WidgetDefinition[] {
    return [
        {
            id: "ticker",
            label: t("portfolio.widget.ticker"),
            defaultVisible: true,
        },
        {
            id: "summaryCards",
            label: t("portfolio.widget.summaryCards"),
            defaultVisible: true,
        },
        {
            id: "allocation",
            label: t("portfolio.widget.allocation"),
            defaultVisible: true,
        },
        {
            id: "performance",
            label: t("portfolio.widget.performance"),
            defaultVisible: true,
        },
        {
            id: "investments",
            label: t("portfolio.widget.investments"),
            defaultVisible: true,
        },
...
export default function PortfolioOverviewPage() {
    ...
    const {
        ...
        resetToDefaults,
        widgets: widgetDefs,
    } = useWidgetVisibility("portfolio", PORTFOLIO_WIDGETS);
        ...
        for (const summary of summaries) {
            ...
            if (group) {
                allocationByGroup.set(
                    group,
                    (allocationByGroup.get(group) || 0) + currentValueInTarget,
                );
            }
    ...
    const cards = [
        {
            ...
            cls: totalGainLossInTarget >= 0 ? "text-gain" : "text-loss",
        ...
        },
        {
            ...
            cls: totalRealizedGainInTarget >= 0 ? "text-gain" : "text-loss",
        ...
        },
        {
            ...
            cls: totalUnrealizedGainInTarget >= 0 ? "text-gain" : "text-loss",
        ...
        <PageShell className="">
            ...
            {isEmpty ? (
                ...
                <>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
                            <div className="sm:col-span-2 lg:col-span-3 lg:row-span-2">
                                <TotalValueCard
                                    formattedTotal={
                                        <Money
                                            amount={totalPortfolioValueInTarget}
                                            currency={targetCurrency}
                                        />
                                    }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:[&>*:only-child]:col-span-2">
                        ...
                        {isVisible("performance") && (
                            <Card>
                                <CardHeader>
                                    <CardTitle>
                                        {t("portfolio.widget.performance")}
                                    </CardTitle>
                                    <CardDescription>
                                    ...
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            },
                                            {
                                                ...
                                                value: totalPortfolioValueInTarget,
                                                cls: "text-foreground",
                                            },
                                            {
                                                label: t(
                                                ...
                                                value: totalRealizedGainInTarget,
                                                cls:
                                            ...
                                            },
                                            {
                                                ...
                                                value: totalUnrealizedGainInTarget,
                                                cls:
                                                ...
                                                ? [
                                                      {
                                                          ...
                                                          value: totalAssetGainInTarget,
                                                          cls:
                                                              totalAssetGainInTarget >=
                                                              0
                                                                  ? "text-gain"
                                                                  : "text-loss",
                                                          showSign: true,
                                            ...
                                            },
                                            {
                                                ...
                                                value: -totalFeesInTarget,
                                                cls: "text-loss",
                                            },
                                            {
                                                label: t(
                                                    "portfolio.totalTaxes",
                                                ),
                                                value: -totalTaxesInTarget,
                                                cls: "text-loss",
                                            },
                                        ].map(
                                            ({
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:items-stretch lg:[&>*:only-child]:col-span-3">
                                                            ...
                                                            <div className="flex items-center gap-3 mt-1 text-xs text-muted-foreground">
                                                                ...
                                                                {unitBased &&
                                                                    inv.totalUnits >
                                                                        ...
                                                                        <span>
                                                                            {t(
                                                                                "portfolio.units.label",
                                                                                {
                                                                                    units: inv.totalUnits.toFixed(
                                                                                        4,
                                                                                    ),
                                                                                    price: fmt(
                                                                                        convertToTarget(
                                                                        ...
                                                                        await confirm(
                                                                            {
                                                                                ...
                                                                                description:
                                                                                    t(
                                                                                        "portfolio.deleteInvestmentDesc",
                                                                                        {
                                                                                            name: inv.name,
                                                                                        },
                                                                                    ),
