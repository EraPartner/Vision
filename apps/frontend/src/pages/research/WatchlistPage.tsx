          ...
          {data.items.map((item) => {
            ...
            return (
              <Card
                ...
                className={cn(
                  "glass-regular premium-frame micro-lift cursor-pointer transition-[box-shadow,border-color] hover:shadow-glass-soft hover:border-primary/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
