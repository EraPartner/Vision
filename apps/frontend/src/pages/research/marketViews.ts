...
export type Region = "worldwide" | "usa" | "europe" | "asia" | "japan" | "latam";
...
export const REGION_VIEWS: ReadonlyArray<MarketView> = [
  {
    key: "worldwide",
...
export const SECTOR_VIEWS: ReadonlyArray<MarketView> = [
  {
    key: "semiconductors",
...
export const REGION_OPTIONS: ReadonlyArray<{ key: Region; labelKey: string }> = [
...
// themed basket.
export const SECTOR_OPTIONS: ReadonlyArray<{ key: string; labelKey: string }> = [
