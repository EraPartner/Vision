...
export const routeLoaders = {
    ...
    "/portfolio/rebalance": () => import("@/pages/portfolio/RebalancePage"),
    "/tax/unified": () => import("@/pages/UnifiedTaxPage"),
    "/research": () => import("@/pages/research/ResearchHomePage"),
    "/research/markets": () => import("@/pages/research/MarketOverviewPage"),
