...
export function mapFromAPI(pt: PlannedTransaction): PlannedPayment {
...
export function mapToCreateAPI(payment: Omit<PlannedPayment, "id" | "created_at">): PlannedTransactionCreate {
...
export function mapToUpdateAPI(updates: Partial<PlannedPayment>): PlannedTransactionUpdate {
