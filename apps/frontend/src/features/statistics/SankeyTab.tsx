...
import { useSankeyFlow } from "@/hooks/useStatistics";
import {
    Select,
    SelectContent,
    SelectItem,
...
export function SankeyTab({
    ...
    const {
        excludedCategoryIds: resolvedCatIds,
        excludedRecipientIds: resolvedRecIds,
    ...
    const { data, isLoading, isError } = useSankeyFlow(
        selectedYear,
        currency,
        excludedCategoryIds,
