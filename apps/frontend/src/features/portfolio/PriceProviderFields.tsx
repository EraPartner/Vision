    ...
    <div className="space-y-3 pt-2 border-t border-border">
      ...
      {form.priceProvider !== 'manual' && form.priceProvider !== 'custom' && (
        <div className="space-y-2">
          <Label htmlFor={`${idPrefix}-provider-id`} className="text-xs">{t('addInv.label.providerId')}</Label>
          <Input
      ...
      {showManualPrice && form.priceProvider === 'manual' && (
        <div className="space-y-2">
          <Label htmlFor={`${idPrefix}-price`} className="text-xs">{t('addInv.label.currentPrice')}</Label>
          <Input
            id={`${idPrefix}-price`}
            type="number"
            step="0.0001"
      ...
      {form.priceProvider === 'custom' && (
        <div className="space-y-3">
          <div className="space-y-2">
            <Label htmlFor={`${idPrefix}-provider-latest-url`} className="text-xs">{t('addInv.label.latestJsonEndpoint')}</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor={`${idPrefix}-provider-latest-path`} className="text-xs">{t('addInv.label.latestJsonPath')}</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor={`${idPrefix}-provider-history-url`} className="text-xs">{t('addInv.label.historyJsonEndpoint')}</Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor={`${idPrefix}-provider-history-path`} className="text-xs">{t('addInv.label.historyArrayPath')}</Label>
            <Input
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              <Label htmlFor={`${idPrefix}-provider-history-ts`} className="text-xs">{t('addInv.label.historyTimestampPath')}</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label htmlFor={`${idPrefix}-provider-history-price`} className="text-xs">{t('addInv.label.historyPricePath')}</Label>
              <Input
