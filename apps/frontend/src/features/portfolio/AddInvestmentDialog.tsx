...
export function AddInvestmentDialog({ allowedAssetClasses }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(
                t("addInv.toast.added", {
                    assetClass: getAssetClassLabel(
                        t,
                        form.assetClass as AssetClass,
                    ),
                    name: form.name,
                }),
            );
            ...
            onOpenChange={(v) => {
                ...
                if (allowedAssetClasses && allowedAssetClasses.length === 1) {
                    ...
                    setForm((f) => ({
                        ...f,
                        assetClass: key,
                        priceProvider: defaultProviderFor(key),
                    }));
                    setStep("details");
                } else {
                    setStep("type");
