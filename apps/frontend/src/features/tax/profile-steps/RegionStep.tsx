...
export function RegionStep({ profile, updateProfile }: StepProps) {
    ...
    const regions: {
        ...
        {
            value: "flanders",
            label: "Flanders (Vlaanderen)",
            desc: "Flemish Region — property taxes and some surcharges differ from other regions.",
            defaultSurcharge: DEFAULT_COMMUNAL_SURCHARGE.flanders,
        },
        {
            value: "wallonia",
            label: "Wallonia (Wallonie)",
            desc: "Walloon Region — slightly higher average communal surcharges.",
            defaultSurcharge: DEFAULT_COMMUNAL_SURCHARGE.wallonia,
        },
        {
            value: "brussels",
            label: "Brussels Capital Region",
            desc: "Brussels-Capital — cosmopolitan municipality rates.",
            defaultSurcharge: DEFAULT_COMMUNAL_SURCHARGE.brussels,
        },
    ];
    return (
        <div className="space-y-5">
            <div>
                <p className="text-sm font-semibold text-foreground mb-1">
                    {t("tax.profile.section.region.title")}
                </p>
                <p className="text-xs text-muted-foreground mb-4">
                    {t("tax.profile.section.region.desc")}
                </p>
            </div>

            <div className="space-y-3">
                <p id="tax-region-label" className="text-sm font-medium">
                        ...
                        >
                            ...
                            >
                                <span className="font-medium text-sm block">
                                    {t(`tax.profile.region.${value}.label`) ||
                                        label}
                                </span>
