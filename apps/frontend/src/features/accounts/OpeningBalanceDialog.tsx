 ...
 *
 * Manual cash accounts whose bank has no CSV export
...
export function OpeningBalanceDialog({
    ...
    const save = useMutation({
        mutationFn: () =>
            apiClient.setOpeningBalance(account.id, {
                balance: parseDecimal(balance, appSettings.numberFormat, NaN),
                date,
    ...
    const canSubmit =
        !save.isPending &&
        balance.trim() !== "" &&
        Number.isFinite(parseDecimal(balance, appSettings.numberFormat, NaN)) &&
        !!date;
    ...
    return (
        ...
        >
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>
                        {t("accounts.openingBalance.title")}
                    </DialogTitle>
                    <DialogDescription>
                        {t("accounts.openingBalance.description", {
