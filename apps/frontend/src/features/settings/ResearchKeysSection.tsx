...
import { useResearchProviderKeys } from "./useSettingsQueries";
...
export function ResearchKeysSection() {
    ...
    const { data, isLoading } = useResearchProviderKeys();
    ...
    const saveMutation = useMutation({
        ...
        onSuccess: () => {
            invalidate();
            toast.success(t("settings.research.saved"));
        },
    ...
    const clearMutation = useMutation({
        ...
        onSuccess: () => {
            invalidate();
            toast.success(t("settings.research.cleared"));
        },
