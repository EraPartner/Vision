...
export function NextSevenDaysStrip({
    ...
    const buckets = useMemo(
        () => bucketNextSevenDays(payments, new Date()),
        [payments],
    );
    ...
    const rangeLabel = t("plannedPage.next7.range", {
        from: formatDateStringWithAppSettings(
            toYmd(buckets[0].date),
                                ...
                                <>
                                    ...
                                    {currencyRatesLoading ? (
                                        ...
                                        >
                                            <Skeleton
                                                aria-hidden
                                                className="inline-block h-4 w-20 align-middle"
                                            />
                                        </span>
                                    ) : (
                                        <span
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-baseline justify-between gap-1">
                                    ...
                                    >
                                        {isToday
                                            ? t("plannedPage.next7.today")
                                            : weekdayFormat.format(bucket.date)}
                                    </span>
                                    <span
                                        className={cn(
