...
export function AddTransactionDialog() {
    ...
    const chosenAccount = normalizedChosen
        ? accountsData?.items.find(
              (a) => a.name.trim().toLowerCase() === normalizedChosen,
          )
        : undefined;
            ...
            <DialogContent className="sm:max-w-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="tx_currency">
                                {t("accounts.field.currency")}
                            </Label>
                            <Input
                                id="tx_currency"
                                placeholder={t("addTxn.currencyPlaceholder")}
                                maxLength={10}
                                value={form.currency}
                                onChange={(e) =>
                                    setForm((f) => ({
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="tx_recipient">
                            {t("form.addTransaction.recipient")}
                        </Label>
                        <RecipientCombobox
                            id="tx_recipient"
                            value={
                                form.recipient_id
                                    ? Number(form.recipient_id)
                                    : null
                            }
                            onSelect={(id) =>
                                setForm((f) => ({
