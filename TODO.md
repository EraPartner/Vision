...
- [x] ⏫ Fix LTTB downsampler: first bucket never sampled, last point duplicated 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ `GET /api/aggregations/cashflow-forecast` throws 500 whenever any planned transaction exists 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ `portfolioSummaryService` double-counts buy/sell fees+taxes in `gainLoss` for unit-based assets 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ `portfolioSummaryService` double-counts rent AND fees/taxes for real-estate `gainLoss` 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ Import commit persists `tx_date` one day early when server TZ ≠ UTC 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ Custom CSV parser: choosing `DD-MM-YYYY` silently imports zero rows 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ Wise adapter books cross-currency OUT transfers on the recipient's side 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔼 Design fix for the whole pg-DATE class: return `DATE` columns as strings 🛫 2026-06-09 ✅ 2026-06-11 (resolved per-site — every day-shift site fixed individually; global setTypeParser(1082) intentionally NOT applied, to avoid app-wide API-contract churn)
...
- [x] 🔼 `computeHeatmap` mis-buckets snapshots into the wrong month when server TZ ≠ UTC 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔼 Recurring `/execute` advances `planned_date` with `toISOString()` (day-shift) + month-end anchor drift 🛫 2026-06-09 ✅ 2026-06-11 (bug 1 fixed via toAppDateString; bug 2 resolved by *documenting* sticky-clamp as intended — no schema change. Anchored alternative left as a follow-up if desired.)
...
- [x] 🔼 `recurrence_pattern` accepted unvalidated → recurring item that never advances 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔼 AI-chat portfolio tools ignore stock splits → holdings/market value wrong by the split ratio 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔼 Loan schedule: first installment can be dated before the loan starts 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔽 Backend Belgian tax table stale: no 2026 entry, missing CGT/Reynders/TACR fields 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔽 `snapshotBuilder` `lastKnownPrice` mixes transaction currency with investment currency 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔽 `portfolioSummaryService`: `totalInvested.abs()` masks negative net-invested + inconsistent "invested" definition 🛫 2026-06-09 ✅ 2026-06-11
  - **File:** `apps/node-backend/src/services/portfolio/portfolioSummaryService.js`.
...
- [x] 🔽 Dividend-WHT reclaim ignores `married_joint` (CGT exemption two functions down does not) 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔽 Belgian-bank adapters: amounts with dot-thousands (`1.234,56`) parse as NaN → row silently dropped 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔽 Wise/SABB adapters parse dates with bare `new Date(string)` (TZ/locale hazards) 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] 🔽 All bank adapters drop unparseable rows silently — surface a skipped count 🛫 2026-06-09 ✅ 2026-06-11 (adapters+pipeline+log+return done & tested; persisted DB column + review-UI badge need a migration — residual)
...
- [x] ⏬ Electron backup: `encryptBundle` ignores stream backpressure 🛫 2026-06-09 ✅ 2026-06-11
...
- [x] ⏫ Frontend portfolio summaries double-count fees/taxes in gainLoss for unit-based assets and double-count rent+fees+taxes for real estate (frontend mirror of the known backend bug, separate code) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ Executing a loan installment never advances planned_date — loan shows as due forever and can be executed repeatedly 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Transaction mutations invalidate a dead ['stats'] query key — Dashboard stat cards, Statistics aggregations, and the filtered recent-transactions widget are never invalidated 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Import commit only invalidates ['import-batches'] — freshly imported transactions don't appear in the transactions list or dashboard until staleTime expires 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 useTransactionListData: in-flight loadMore page from a previous filter/search is appended after the filter changes — requestId is only bumped on sort changes 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 updatePattern validates merged-with-defaults instead of the existing row — blocks case_sensitive-only updates and bypasses the ReDoS guard on pattern-only updates 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 mergeRecipients leaves nested aliases pointing at a merged alias — alias chains break the one-level read layer and divert future imports 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Transactions list pagination has no unique ORDER BY tiebreaker — same-date rows can be duplicated or skipped across pages 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Saved-charts PATCH cannot clear date_range_start/end — null is coerced to undefined and silently dropped 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Bulk PUT /api/settings bypasses the per-key validation enforced by PUT /api/settings/:key (cost_basis_method allowlist, exclusionScope, excludeHiddenCategories) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Tags-only PATCH on a nonexistent transaction returns 500 (FK violation) instead of 404 — junction insert runs before any existence check 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Streamed export paginates with OFFSET across separate pool queries — a concurrent write mid-export silently drops or duplicates rows 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ Cashflow planned overlays include executed planned transactions → double counting against actuals 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Forecast methods average only days-with-transactions (no zero-fill) → conditional-mean bias; EWMA never decays stale buckets 🛫 2026-06-10 ✅ 2026-06-11 (engine-level zero-fill in runForecastEngine + walk-forward backtests; methods unchanged)
...
- [x] 🔼 Category-forecast reconciliation scales by ref/sum — explodes when mixed-sign categories nearly cancel 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 average-vs-current: monthly projection multiplies a per-active-day rate by full calendar days (wrong denominator) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Monthly-summary MV fast path converts month aggregates at the month-start FX rate — contradicts the live path's own correctness comment 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Planned-expenses-next-month counts each recurring item once at its current (possibly current-month) date and ignores is_executed 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ Bank-balances 12-month history query materializes ~12× the whole transactions table via ROW_NUMBER over a months×transactions join 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ getCategoryPivot streams every active transaction row into JS (unbounded, sorted) and aggregates per month/category in JavaScript 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 getRecipientByYear pulls every expense transaction row into JS to compute top-20 recipients per year 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Saved-chart recipient pivot fetches the pivot for ALL recipients, then the client discards everything but the chart's few selected recipients 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Sankey aggregation streams a full year of transaction rows into JS where an exactly-equivalent SQL GROUP BY returns ~50 rows 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Dashboard stats queryFn awaits two independent API calls sequentially 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ Dashboard exclusion filters drifted: canonical buildExclusionClauses has zero production callers while four hand-rolled SQL variants disagree on alias and category semantics 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 MSW default handlers mock wrong response shapes for four /api/info endpoints and the msw contract suite pins the wrong shapes, contradicting the live-contracts suite 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Bank-adapter catalog maintained in three places: frontend-facing endpoint hardcodes the list (with adapter_class names that don't exist) while the registry-backed endpoint is dead 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Historical-FX conversion (`useHistoricalRatesByDate: true`) is silently inert for DB-sourced date rows — falls back to today's rate 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Saved charts: `yearly` time bucket is broken three ways (blank line/area charts, monthly granularity for categories, first year dropped by date filter) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Statistics "Spending by Category" donut and "Top Category Trends" include income categories — salary shows up as the biggest "spending" slice 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Dashboard "Spending by Category" donut actually shows transaction *counts* over the latest 50 transactions of all time — not this month, not spending 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 "Top Recipients by year" can never honor category exclusions — missing through the whole chain, and the filtered query is disabled when only categories are excluded 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Bank-balances history chart: stacked area breaks with negative balances, and accounts whose *current* balance is zero vanish from all history 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Sankey & Recipient-Insights surfaces bypass the centralized exclusion resolver — hidden categories (and on insights, *all* category exclusions) leak in; **user-confirmed:** the statistics Recipients-tab KPI cards ignore excluded recipients 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Forecast diagnostics "Suggested Ensemble Weights" don't match what `ensemble_imse` actually does (1/MAE² unshrunk vs shrunk 1/RMSE² + uniform floor) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Portfolio Overview "Last 30 days" sparkline shows cost-basis *contributions* but is styled as performance (green/red ±% badge) — and the same label on the Performance page means portfolio *value* 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 `LineChart` primitive: `connectNulls` semantics are inverted (latent — no current consumer regresses) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏬ Dead chart code: `CashFlowComparisonChart` and `MonthlySpendingChart` have zero consumers 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ Frontend portfolio math ignores corporate-action transaction types — units, cost basis, and unrealized gain (absolute **and** relative) wrong after any split or return of capital 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏫ Fixed-income `gainLoss` double-counts interest — `realizedGain = totalInterestPaid` AND `totalIncome` includes the same interest (backend **and** frontend, branch not covered by the filed double-count items) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 StocksPage/MetalsPage and CryptoPage "Net gain" cards double-subtract fees/taxes (hand-rolled formulas not covered by the round-4 `usePortfolioSummaries` item) 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Category pivot "Income"/"Expense" metrics classify by the sign of the category-month **net** — mixed-sign months are misclassified, the drill-through contradicts the cell, and Tax Overview inherits the skew 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Recipient insights month-over-month compares a *partial* current month against the *full* previous month 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔽 Planned payments "Est. monthly" card: planned *income* inflates it (abs of amount), and mixed currencies are summed without conversion 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] ⏬ Monthly-summary MV fast path omits zero-transaction months that the live path zero-fills — dashboard month set changes when exclusions toggle the path 🛫 2026-06-10 ✅ 2026-06-11
...
- [x] 🔼 Portfolio chart LTTB downsampling: not needed at this app's scale, and it *amplifies* the bad kinesis price needles — remove (or raise threshold) and sanitize spikes at the source instead 🛫 2026-06-10 ✅ 2026-06-11
